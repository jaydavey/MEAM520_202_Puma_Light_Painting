...
studentnames = 'Alex McCraw, Jay Davey, and Vivienne Clayton';
...
[~, xs, ys, zs, phis, thetas, psis, rs, gs, bs] = team202_get_poc(tstart);
...
allSolutions = team202_puma_ik(xs, ys, zs, phis, thetas, psis);
